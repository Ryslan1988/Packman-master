...
public class Packman extends JComponent {
  ...
  private static int betta = 300;
  private static int Limit_alpha = 30;
  //шаг изменения угла
  private static int h_alpha = 30;
  private  int r = 10;
  private static double coeff_w = 0.5;
  private static double coeff_h = 0.25;
  private static boolean RightWasPressed = false;
  private static boolean LeftWasPressed = false;
  private static boolean UpWasPressed = false;
  private static boolean DownWasPressed = false;
